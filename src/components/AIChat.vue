<template>
  <div>
    <button
      ...
      class="fixed bottom-20 right-20 z-[100] w-16 h-16 rounded-full bg-brand text-white shadow-xl hover:bg-brand-dark transition flex items-center justify-center"
    >
      <i
        :class="
          chatOpen
    ...
    <div
      v-if="chatOpen"
      class="fixed bottom-40 right-6 z-[100] w-[360px] h-[520px] bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col resize overflow-auto"
    >
      <div
        class="bg-brand text-white px-5 py-4 flex items-center justify-between"
      >
        <div>
          <h3 class="font-bold">SeoulHub AI</h3>
